...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shaik Nazeer Basha — Portfolio" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Shaik Nazeer Basha" },
      { property: "og:title", content: "Shaik Nazeer Basha — Portfolio" },
      {
        property: "og:description",
        content:
          "AI · Cybersecurity · IoT · Frontend Developer based in Mangalagiri, India.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@nzeertech" },
    ],
    links: [
      {
        rel: "stylesheet",
